...
import styles from "../styles/CS12att.css";
const CS12Attendance = () => {
    ...
    const fetchStudents = async () => {
        try {
            const response = await axios.get('http://127.0.0.1:8000/api/attendancecs12');
    ...
    const handleAttendanceSubmit = async (student) => {
        ...
        try {
            // Submit attendance
            await axios.post('http://127.0.0.1:8000/api/attendancecs12', {
