...
import styles from '../styles/CS11marks.module.css';
...
const CS11marks = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post('http://127.0.0.1:8000/api/markscs11', formData);
