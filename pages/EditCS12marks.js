...
import styles from '../styles/EditCS12marks.module.css';
...
const EditCS12marks = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://127.0.0.1:8000/api/markscs12');
    ...
    const handleUpdate = async (index) => {
        try {
            const response = await axios.put('http://127.0.0.1:8000/api/markscs12', filteredData[index]);
    ...
    return (
        <div className={styles.editContainer}>
            <h2 className={styles.title}>Edit CS 12 Marks</h2>
