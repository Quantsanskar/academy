...
import styles from '../styles/EditChem11marks.module.css';

const EditChem11marks = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://127.0.0.1:8000/api/markschem11');
    ...
    const handleUpdate = async (index) => {
        try {
            const response = await axios.put('http://127.0.0.1:8000/api/markschem11', filteredData[index]);
    ...
    return (
        <div className={styles.editContainer}>
            <h2 className={styles.title}>Edit Chemistry 11 Marks</h2>
...
export default EditChem11marks;