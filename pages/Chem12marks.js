...
import styles from '../styles/Chem12marks.module.css';
...
const Chem12marks = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post('http://127.0.0.1:8000/api/markschem12', formData);
