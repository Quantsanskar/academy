...
import styles from '../styles/CS12marks.module.css';
...
const CS12marks = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post('http://127.0.0.1:8000/api/markscs12', formData);
