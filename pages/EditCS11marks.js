...
import styles from '../styles/EditCS11marks.module.css';
...
const EditCS11marks = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://127.0.0.1:8000/api/markscs11');
    ...
    const handleUpdate = async (index) => {
        try {
            const response = await axios.put('http://127.0.0.1:8000/api/markscs11', filteredData[index]);
    ...
    return (
        <div className={styles.editContainer}>
            <h2 className={styles.title}>Edit CS 11 Marks</h2>
